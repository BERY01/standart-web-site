...
<footer class="sticky-footer bg-gradient-dark">
    <div class="container my-auto">
        <div class="copyright text-center text-white my-auto">
            <span>Copyright &copy; Digicat Reklam ve Yazılım | {{date('Y')}}</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title text-danger" id="exampleModalLabel">Çıkış Yapıyorsunuz !</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" class="text-danger">×</span>
        </button>
    </div>
    <div class="modal-body text-primary">Çıkış yapmak istediğinize emin misin?</div>
