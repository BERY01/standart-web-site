...
<head>
    ...
    <link rel="stylesheet " href="{{asset('front/css/paginate.css ')}}">
    <link rel="stylesheet" href="{{asset('front/node_modules/@splidejs/splide/dist/css/splide.min.css')}}">
    <!-----BOOTSTRAP------>
...
<body>
    ...
    <div class="site-mobile-menu ">
        <div class="site-mobile-menu-header">
            ...
            <div class="container">
                <h6>" İmalattan montaja her aşamada kalite... "</h6>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-9 col-xl-2 ">
                    <a href="/" class="text-white mb-0"><img alt="3breklam" class="site-logo" id="site-logo" src="{{$config->logo}}"></a>
                </div>
                <div class="col-12 col-md-10 d-none d-xl-block">
                    <nav class="site-navigation position-relative text-right" role="navigation ">

                        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block ">
                            <li class = "@if(Request::segment(1)==null) active @endif"><a href="{{url('/')}}"><span>Anasayfa</span></a></li>

                            <li class="has-children @if(Request::segment(1)=="kategori") active @endif">
                                <a href="{{url('#hizmetlerimiz')}}"><span>Hizmetlerimiz</span></a>
                                <ul class="dropdown ">
                                    @foreach ($categories as $category)
                                    <li  class="@if(Request::segment(2)==$category->slug) active @endif">
                                        <a @if(Request::segment(2)!=$category->slug) href="{{route('category',[$category->slug,$category->id])}}" @endif>
                                        {{$category->name}}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </li>
                            <li><a href="{{url('#hakkimizda')}}"><span>Hakkımızda</span></a></li>
                    ...
                    <a href="#" class="site-menu-toggle js-menu-toggle">
                        <span class="icon-menu">
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon"
                                style="width: 3em; height: 3xwem;vertical-align: middle;fill: currentColor;overflow: hidden;"
